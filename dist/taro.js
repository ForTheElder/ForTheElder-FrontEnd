...
/* harmony export */ });
/* unused harmony exports Ad, AdCustom, Audio, Block, Camera, Canvas, CheckboxGroup, CustomWrapper, Editor, Form, FunctionalPageNavigator, Icon, KeyboardAccessory, Label, LivePlayer, LivePusher, Map, MatchMedia, MovableArea, MovableView, NativeSlot, NavigationBar, Navigator, OfficialAccount, OpenData, PageMeta, PickerView, PickerViewColumn, Progress, Radio, RadioGroup, RichText, RootPortal, ScrollView, ShareElement, Slider, Slot, Swiper, SwiperItem, Video, VoipRoom, WebView */
var View = 'view';
var Icon = 'icon';
